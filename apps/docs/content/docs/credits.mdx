...
- [Fumadocs](https://www.fumadocs.dev) for documentation content and layout infrastructure.
- The Erebuz documentation app for the dark-first documentation shell and navigation structure used by this site.
